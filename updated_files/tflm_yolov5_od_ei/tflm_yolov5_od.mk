...
# LIB_SEL = pwrmgmt sensordp tflmtag2310_u55tag2308 spi_ptl spi_eeprom hxevent img_proc
...
override LINKER_SCRIPT_FILE := $(SCENARIO_APP_ROOT)/$(APP_TYPE)/TFLM_yolov5_od_S_only.sct
else#TOOLChain
override LINKER_SCRIPT_FILE := $(SCENARIO_APP_ROOT)/$(APP_TYPE)/TFLM_yolov5_od_S_only.ld
endif
