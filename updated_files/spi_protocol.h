...
#define MAX_TRACKED_YOLOV5_ALGO_RES 40
typedef enum
{
	DATA_TYPE_JPG               = 0x01,
	DATA_TYPE_BMP               = 0x02,
	...
	DATA_TYPE_META_YOLOV5_OB_DATA = 0X9A, /*YOLOV5 object detection*/
...
typedef struct
{
	struct_yolov8_ob obr[MAX_TRACKED_YOLOV5_ALGO_RES];
	uint32_t algo_tick;
}struct_yolov5_ob_algoResult;
...
typedef struct
{
	detection_yolov8_pose dypr[MAX_TRACKED_YOLOV5_ALGO_RES];
	uint32_t algo_tick;
}struct_yolov5_pose_algoResult;
